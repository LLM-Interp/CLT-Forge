...
sbatch --job-name=clt_full examples/lora/sbatch_clt.sh full 0

# LoRA with different ranks
sbatch --job-name=clt_lora_r16 examples/lora/sbatch_clt.sh lora 16
sbatch --job-name=clt_lora_r32 examples/lora/sbatch_clt.sh lora 32
sbatch --job-name=clt_lora_r64 examples/lora/sbatch_clt.sh lora 64
sbatch --job-name=clt_lora_r128 examples/lora/sbatch_clt.sh lora 128
